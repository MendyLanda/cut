/**
 * Lucide icons as hono/jsx components. lucide-react ships React components that
 * don't run under hono/jsx, so the path data (MIT, lucide.dev) is inlined here.
 * Shared attrs match lucide's defaults: 24x24, no fill, currentColor stroke 2px.
 */
import type { Child } from "hono/jsx";

type IconProps = { size?: number; class?: string };

function icon(children: Child) {
  return ({ size = 24, class: cls }: IconProps) => (
    <svg
...
export function GitHubMark({ class: cls }: { class?: string }) {
  return (
